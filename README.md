...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Auto-generated interactive API docs at `/docs/swagger/`. Explore endpoints, inspect schemas, and try requests in the browser. OpenAPI JSON at `/docs/swagger/openapi.json`. See [complex example](examples/09_complex/). | Visual dependency graph of your module tree at `/docs/modules/`. Shows modules, controllers, providers, and methods in an interactive force-directed layout. See [complex example](examples/09_complex/). |
